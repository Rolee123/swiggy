<%@page import="java.sql.Statement,java.sql.Connection,java.sql.ResultSet,java.sql.DriverManager,java.util.*" %>
<!DOCTYPE html>
<html lang="en">
<!-- Copied from http://htmldemo.themessoft.com/freshia/version1/about_us.html by Cyotek WebCopy 1.6.0.559, 18 November 2018, 17:52:13 -->
<head>
<meta charset="utf-8">
<!--[if IE]>
...
<script>
    $(document).ready(function(){
        $(".button.btn-cart.ajx-cart").click(function(){
           var data = $(this).val();
           console.log("hell");
           $.ajax({
               url: "Cart?item="+data,
                      ...
                      <li class="item first">
                        <div class="item-inner"> <a class="product-image" title="Retis lapen casen" href="#l"><img alt="Retis lapen casen" src="products-images/product4.jpeg"> </a>
                          <div class="product-details">
                            ...
                            <!--access-->
                            <p class="product-name"><a href="#"><% out.println(item); %></a> x <strong><% out.println(session.getAttribute(item)); %></strong></p>
                          </div>
                        </div>
                      </li>
                       <%}out.println("<p style=\"text-align: center;\">Total Price: "+session.getAttribute("price")+"</p>");}
                            else{
                                out.println("<p style=\"text-align: center;\">No items in cart!!</p>");
                            }   
                        %>
                    </ul>
  ...
  <div class="breadcrumbs">
    <div class="container">
      <div class="row">
        <div class="col-xs-12">
          <ul>
            <li class="home"> <a title="Go to Home Page" href="index-1.html">Home</a> <span>/</span> </li>
  ...
  <div class="main-container col2-right-layout">
    <div class="main container">
      <div class="col-sm-12">
            ...
            <div class="slider-items-products">
              <div id="category-desc-slider" class="product-flexslider hidden-buttons">
                <div class="slider-items slider-width-col1 owl-carousel owl-theme"> 
                  ...
                  <!-- Item -->
                  <div class="item"> <a href="#"><img alt="" src="images/category-img1.jpeg"></a>
                    <div class="cat-img-title cat-bg cat-box">
                      <div class="small-tag">Season 2018</div>
                      <h2 class="cat-heading">100% Organic</h2>
                  ...
                  <!-- Item -->
                  <div class="item"> <a href="#"><img alt="" src="images/category-img2.jpeg"></a>
                    <div class="cat-img-title cat-bg cat-box">
                      <div class="small-tag">Freshia Fruits</div>
          ...
          <article class="col-main" style="float: left;">
            <h2 class="page-heading"> <span class="page-heading-title">Items</span> </h2>
            <div class="display-product-option">
              <div class="sorter">
                <div class="view-mode"><span class="button button-active button-list" title="List">&nbsp;</span> </div>
              </div>
            </div>
                ...
                <li class="item first">
                    <%
                        ...
                        if(request.getParameter("restaurant") != null){
                            session.setAttribute("restaurant",request.getParameter("restaurant"));
                            restaurant = request.getParameter("restaurant");
                            restaurant2 = restaurant.replaceAll("\\s","");
                        }
                        else if(session.getAttribute("restaurant") !=  null){
                            restaurant = session.getAttribute("restaurant").toString();
                            restaurant2 = restaurant.replaceAll("\\s","");
                        }
                        ...
                        while(rs.next()){                        
                    %>
                  <div class="product-image"> <a title=""> <img class="small-image" src="products-images/product1.jpeg" alt=""> </a> </div>
                  <div class="product-shop">
                      <h2 class="product-name"><a href=""><% out.println(rs.getString(1)); %></a><br><% out.println(rs.getString(3)); %>(<% out.println(rs.getString(4)); %>)</h2>
                    <div class="ratings">
                    ...
                    <div class="price-box">
                      <p class="special-price"> <span class="price-label"></span> <span class="price"><% out.println(rs.getString(2)); %></span> </p>
                    </div>
                    <div class="actions">
                      <button class="button btn-cart ajx-cart" title="Add to Cart" type="button" value="<% out.println(rs.getString(1)); %>"><span>Add to Cart</span></button>
                    </div>
                  </div>
                </li><%}%>   
              </ol>    
              <button class="button btn-proceed-checkout" title="Cart" type="button" style="float: right;"><span><a href="shopping_cart.jsp" style="margin: 10px 15px;">Proceed to Cart</a></span></button>
            </div>
          </article>
          <!--	///*///======    End article  ========= //*/// --> 
        </div>
