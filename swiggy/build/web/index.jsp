<!DOCTYPE html>
<html lang="en">
<!-- Copied from http://htmldemo.themessoft.com/freshia/version1/login.html by Cyotek WebCopy 1.6.0.559, 18 November 2018, 17:52:13 -->
<head>
<meta charset="utf-8">
<!--[if IE]>
...
<body class="shopping-cart-page" style="background-color: white">
<div id="page"> 
    <img src="https://s3-ap-southeast-1.amazonaws.com/icb-images/storeLogos/swiggy-cashback-and-coupon-offers-31103963.jpg" style="height:150px;margin-left: 35%">
 <!-- Header -->
<!--  <header>
        ...
        <div class="container">
          <div class="row"> 
            ...
            <div class="col-xs-12 col-sm-6">
              <div class="dropdown block-language-wrapper"> <a class="block-language dropdown-toggle" > <img src="images/english.png" alt="language"> India <span class="caret"></span> </a>
                <ul class="dropdown-menu" role="menu">
                  <li role="presentation"> <a href="#"><img src="images/english.png" alt="language"> Hindi </a> </li>
                  <li role="presentation"> <a href="#"><img src="images/francais.png" alt="language"> punjabi </a> </li>
                  <li role="presentation"> <a href="#"><img src="images/german.png" alt="language"> Gujrati </a> </li>
                </ul>
...
<!--<div class="top-cart-contain pull-right"> 
  ...
  <!-- end header -->  
  <section class="main-container top-space col1-layout" style="margin-top: 0">
    <div class="main container">
      <div class="account-login">
          <div class="col-sm-12"style="padding: 0px">
              <div class="search-box">
              <div id="search_mini_form">
                <input type="text" placeholder="Enter location" maxlength="70" id="location" style="width:90%;border: solid #333;padding: 0px 10px;height: 45px;border-right: 0px;color: #333;">
                <button type="button" class="search-btn-bg" style="width: 10%;border: solid #333;border-left: 0px;"><span class="glyphicon glyphicon-search"></span>&nbsp;</button>
              </div>
            </div>
          </div>
            ...
            <form  action="signup" method="post">
              ...
              <ul class="form-list">
                <li>
                  ...
                  <br>
                  <input type="text" title="Email Address" class="input-text required-entry" id="email" value="" name="user2" required>
                </li>
                <li>
                  <label for="pass">Password <span class="required">*</span></label>
                  <br>
                  <input type="password" title="Password" id="pass3" class="input-text required-entry validate-password" name="pwd2" required>
                  <label for="pass">Password <span class="required">*</span></label>
                  <br>
                  <input type="password" title="Password" id="pass2" class="input-text required-entry validate-password" name="pwd3" required>
                </li>
              </ul>
              <p class="required">* Required Fields</p>
              <div class="buttons-set">
                <button id="send3" name="send" type="submit" class="button login"><span>Login</span></button>
             ...
             <form action="Login" method="post" id="login">
              ...
              <ul class="form-list">
                <li>
                  <label for="email">Email Address <span class="required">*</span></label>
                  <br>
                  <input type="text" title="Email Address" class="input-text required-entry" id="email1" value="" name="user" required>
                </li>
                <li>
                  <label for="pass">Password <span class="required">*</span></label>
                  <br>
                  <input type="password" title="Password" id="pass1" class="input-text required-entry validate-password" name="pwd" required>
                </li>
                  <input type="text" id="pooptag" value="" name="location">
              </ul>
              <p class="required">* Required Fields</p>
              <div class="buttons-set">
